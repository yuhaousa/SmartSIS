...
import { BookOpen, Lock, Mail, ArrowRight, GraduationCap, AlertCircle } from 'lucide-react';
...
const Login: React.FC<LoginProps> = ({ onLogin, language }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      if (email === 'demo@mail.com' && password === 'demo123') {
        onLogin();
      } else {
        setError(language === 'en' ? 'Invalid credentials. Please try again.' : '凭证无效，请重试。');
      }
    }, 1500);
  };
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-3 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition-colors ${error ? 'border-red-300' : 'border-gray-300'}`}
            ...
            <div className="mt-6 text-center text-xs text-gray-500 bg-gray-50 p-3 rounded-lg border border-gray-200">
              ...
              <p>Email: <span className="font-mono text-gray-700">demo@mail.com</span></p>
              <p>Password: <span className="font-mono text-gray-700">demo123</span></p>
            </div>
          </form>
        </div>
      </div>
